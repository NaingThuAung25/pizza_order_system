            ...
            <div class="col-lg-4">
                ...
                <div class="bg-light p-30 mb-5">
                    ...
                    <div class="pt-2">
                        ...
                        <button class="btn btn-block btn-dark font-weight-bold my-3 py-3" id="orderBtn">
                            <span class="text-white">Procced To Checkout</span>
                        </button>
...
@section('scriptSource')
    ...
    <script>
        ...
        //remove current product when delete button click
