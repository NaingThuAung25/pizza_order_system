                    ...
                    <ul class="list-unstyled navbar__list">
                        <li>
                            <a href="{{ route('category#list') }}">
                                <i class="fa-regular fa-rectangle-list text-info"></i>Category
                            </a>
                        </li>

                        <li>
                            <a href=" {{route("product#list")}} ">
                                <i class="fa-solid fa-pizza-slice text-warning"></i>Products
                            </a>
                        </li>

                        <li>
                            <a href="{{ route('admin#orderList') }}">
                                <i class="fa-solid fa-list-check text-primary"></i>Order List
                            </a>
                        </li>
                                        ...
                                        <div class="image">
                                            @if (Auth::user()->image == null)
                                                @if (Auth::user()->gender == 'male')
                                                    <img src="{{ asset('image/default_user_male.png') }}"
                                                        class="img-thumbnail">
                                                @else
                                                    <img src="{{ asset('image/default_user_female.png') }}"
                                                        class="img-thumbnail">
                                                @endif
                                            @else
