        ...
        <div class="section__content section__content--p30">
            <div class="container-fluid">
                <div class="col-md-12">
                    ...
                    <div class="row mt-2">
                        <div class="col-1 offset-11 p-2 text-center mb-3">
                            <h3> <i class="fa-solid fa-database mr-2 text-info"></i>{{ $categories->total() }} </h3>
                        </div>
                    </div>
                    ...
                    @if (count($categories) != 0)
                        <div class="table-responsive table-responsive-data2">
                            ...
                            <div class="mt-3">
                                {{ $categories->links() }}
                                {{-- {{ $categoies->appends(request()->query())->links() }} --}}
                            </div>
                        </div>
                    @else
