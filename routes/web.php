...
Route::middleware(['auth'])->group(function() {
    ...
    Route::middleware(['admin_auth'])->group(function(){
        ...
        Route::prefix('products')->group(function(){
            Route::get('list',[ProductController::class,'list'])->name('product#list'); //pizzalist.blade.php ka nay direction pay ProductController import lote
    ...
    //User
    //home middleare kar htar yin user pal win ya
    Route::group(['prefix'=>'user','middleware'=>'user_auth'],function(){
        Route::get('/homePage',[UserController::class,'home'])->name('user#home'); //user controller import
